...
\date{March 30, 2026}
\titlegraphic{\includegraphics[width=0.42\linewidth,keepaspectratio]{Roadmap_terms.png}}
...
Computational methods help us study these data systematically and at scale.
...
\vspace{0.3cm}
Today we focus mainly on the first two steps.
\end{frame}

\begin{frame}{The new AI landscape}
Recent developments in AI have changed how many people think about language and text.

\begin{itemize}
	\item Large Language Models (LLMs)
	\item AI assistants such as ChatGPT and Copilot
	\item Automated classification, summarization, and generation
\end{itemize}

\vspace{0.4cm}

\textbf{Key point:} To understand these tools critically, it helps to understand the basics of computational text analysis.
\end{frame}

\begin{frame}{Where do LLMs fit?}
\begin{itemize}
	\item Modern AI systems can automate many language tasks
...
\vspace{0.3cm}
\textbf{Takeaway:} Understanding the basics helps you evaluate newer AI systems more critically.
\end{frame}
...
{\small(tokenization, cleaning, stopwords)}
...
Text can be interesting for at least two reasons:
\begin{itemize}
	\item because the \textbf{text itself} is what we want to study
	\item because text can be used as a \textbf{means} to answer a broader question
\end{itemize}
\end{frame}
...
\begin{itemize}
	\item We can study what people talk about on health-related platforms (e.g., \cite{sanders_different_2020})
	\begin{itemize}
		\item For example: which topics appear on expert-generated versus peer-generated platforms?
	\end{itemize}
	\item We can compare different media environments (e.g., \cite{burggraaff_through_2020})
	\begin{itemize}
...
\begin{columns}[T]
	\begin{column}{0.65\textwidth}
		\begin{block}{Definition}
			Natural Language Processing (NLP) is a field that studies how computers can process and analyze human language.
		\end{block}
...
\begin{block}{Word co-occurrence in disease surveillance}
\begin{itemize}
	\item analyzes which words appear together
	\item can reveal patterns without predefined categories
...
texts = [
    "Communication in the digital society is very very complex",
    "I like to study digital communication"
]
...
\begin{minted}{python}
texts = [
    "Communication in the digital society is complex",
    "I like to study it"
]
...
\begin{description}
	...
	\item[\emph{Pruning}] removing unnecessary words or symbols
	\item[\emph{Lemmatization / stemming}] reducing variation in words
	\item[\emph{N-grams}] capturing neighboring words
\end{description}
\end{block}
...
tokens_without_stopwords = [
    [word for word in doc if word.lower() not in mystopwords]
    for doc in tokens
]
...
\begin{itemize}
	\item NLTK is great for learning the basics
	\item Other common tools include \texttt{spaCy} and transformer-based models
	\item The core logic remains similar:
	\begin{itemize}
		\item tokenize
		\item represent
		\item model
...
\begin{itemize}
	...
	\item Text needs to be transformed into structured data
