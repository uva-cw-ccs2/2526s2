...
\begin{frame}{Similarity between movies}
  \only<1>{\makebox[\linewidth]{\includegraphics[width=\columnwidth,height=\paperheight,keepaspectratio]{Slide1.png}}}
  \only<2>{\makebox[\linewidth]{\includegraphics[width=\columnwidth,height=\paperheight,keepaspectratio]{Slide2.png}}}
  \only<3>{\makebox[\linewidth]{\includegraphics[width=\columnwidth,height=\paperheight,keepaspectratio]{Slide3.png}}}
  \only<4>{\makebox[\linewidth]{\includegraphics[width=\columnwidth,height=\paperheight,keepaspectratio]{Slide4.png}}}
  \only<5>{\makebox[\linewidth]{\includegraphics[width=\columnwidth,height=\paperheight,keepaspectratio]{Slide5.png}}}
\end{frame}
...
\begin{frame}{Item-based filtering}
  \begin{block}{Core idea}
    \begin{itemize}[<+>]
      \item Look at which items are bought by the same users
      \item If many users buy both item \textit{X} and item \textit{Y} \ldots
      \item \ldots then these items are probably \textbf{similar}
      \item So: if a user buys \textit{Y}, we recommend \textit{X}
    \end{itemize}
  \end{block}

  \begin{exampleblock}{Example (Amazon)}
    Many users buy a \textit{phone} together with a \textit{phone case}. \\
    You buy a phone. \\
    
    \vspace{0.3em}
    $\Rightarrow$ Amazon recommends a phone case.
  \end{exampleblock}
\end{frame}
