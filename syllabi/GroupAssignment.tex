...
\begin{enumerate}
	...
	\item \emph{Spotify Lyrics dataset}: This dataset contains Spotify tracks together with their song lyrics and metadata such as artist, genre, and popularity. The dataset is available on \href{https://www.kaggle.com/datasets/evabot/spotify-lyrics-dataset}{Kaggle}.
\end{enumerate}
...
\subsection{Appendix: AI use disclosure (if applicable)}

If AI tools were used during the project, briefly describe how they were used. 
AI tools may be used to support learning (e.g., clarifying concepts or debugging code), but not to generate substantial parts of the submitted code or text.

If applicable, specify:
\begin{itemize}
\item which AI tool was used (e.g., UvA Chat AI),
\item for which purpose it was used (e.g., explaining an error message or clarifying a concept),
\item how the output was evaluated or modified by the group.
\end{itemize}

If no AI tools were used, please explicitly state: \emph{“No AI tools were used in the preparation of this assignment.”}
...
\section{Handing in}
One member of your group can hand in the group assignment. \textbf{Please compress all files into a single .zip or .tar.gz file} 
